...
@Database(entities = [Stock::class, StockTransaction::class, StockHistoryPrice::class, Account::class], version = 20, exportSchema = false)
    ...
    companion object {
        ...
        fun getDatabase(context: Context): AppDatabase {
            return INSTANCE ?: synchronized(this) {
                ...
                .addMigrations(MIGRATION_3_4, MIGRATION_4_5, MIGRATION_7_8, MIGRATION_8_9, MIGRATION_9_10, MIGRATION_10_11, MIGRATION_11_12, MIGRATION_12_13, MIGRATION_13_14, MIGRATION_14_15, MIGRATION_15_16, MIGRATION_16_17, MIGRATION_17_18, MIGRATION_18_19, MIGRATION_19_20)
                .build()
                INSTANCE = instance
                instance
            }
        ...
        private val MIGRATION_18_19 = object : Migration(18, 19) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE accounts ADD COLUMN `feeDiscount` REAL")
            }
        }

        private val MIGRATION_19_20 = object : Migration(19, 20) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE accounts ADD COLUMN `minFeeRegular` INTEGER")
                db.execSQL("ALTER TABLE accounts ADD COLUMN `minFeeOddLot` INTEGER")
            }
        }
    }
}
