...
class TwseStockHistoryServiceTest {
    ...
    private val mockDao = object : StockDao {
        ...
        override suspend fun getStocksByCodes(codes: List<String>): List<Stock> = emptyList()
        ...
        override fun getTransactionsForStockAndAccount(stockCode: String, accountId: Int): Flow<List<StockTransaction>> = flowOf(emptyList())
